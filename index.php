...
<head>
    ...
    <title><?php echo ucwords(str_replace('_','',$page)) ?> | VK PHARMACY</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-gradient" id="topNavBar">
        <div class="container">
            ...
            <?php else: ?>
                <a href="javascript:void(0)" id="login-btn"style="color:black;">Login</a>
                |
                <a href="javascript:void(0)" id="register-btn" style="color:black;">Register</a>
            <?php endif; ?>
